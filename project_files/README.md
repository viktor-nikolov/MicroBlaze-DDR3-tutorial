...
> Then, in Vitis, you right-click the "system" project in the Explorer select "Update Hardware Specification" and select the .xsa file generated by Vivado. With the HW specification updated, you must re-build the Vitis workspace.
